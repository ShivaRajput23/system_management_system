<?php
    ...
    $id=$_GET['id'];
    $sql="SELECT logs.*, data.system_no FROM logs RIGHT JOIN data ON logs.system_id=data.system_id Where inv_id='$id'" ;
                                    ...
                                    <tbody>
                                        <?php foreach($inv_list_arr as $row) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-danger btn-sm"  onclick="return confirm('Are you sure?')" href='<?=$baseurl?>/crud/delete_logs.php?id=<?= $row['id']?> && system_id=<?= $id?>'>
